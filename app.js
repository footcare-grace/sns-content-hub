...
/* ================= 状態 ================= */
const LS={axis:"hub-axis-v1",tasks:"hub-tasks-v1",leads:"hub-leads-v1",buzz:"hub-buzzstock-v1"};
let axis=null, tasks=[], leads=[], buzzStock=[];
...
function load(){
  ...
  }catch(e){axis=null;tasks=[];leads=[];buzzStock=[];}
}
...
$("#btn-export").addEventListener("click",()=>{
  const data={axis,tasks,leads,insightLog,buzzStock,exported:new Date().toISOString()};
...
$("#import-file").addEventListener("change",e=>{
  ...
  r.onload=()=>{
    try{
      ...
      saveAxis();saveTasks();saveLeads();saveInsights();saveBuzz();
      fillAxisForm();renderTasks();renderLeads();renderAxisBanners();renderInsights();renderBuzz();
      alert("復元しました");
